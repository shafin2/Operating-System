...
int main(){
    ...
    // 2nd 0 indicate semaphore is for thread not for seprate processes, 3rd arg 0 indicate semaphore value occupied intially
    sem_init(&s1, 0, 0);
    sem_init(&s2, 0, 0);
    sem_init(&s3, 0, 0);
    sem_init(&s4, 0, 0);
    ...
    // the fourth arg null indicates no parameter passed to function A
